...
-- Workspaces
    ...
    -- Scratchpads
        , ((Config.modMask, xK_F1),                                     namedScratchpadAction Scratchpads.pads Config.mainScratchpad)
        , ((Config.modMask, xK_F2),                                     namedScratchpadAction Scratchpads.pads "keepass")
        , ((Config.modMask, xK_F3),                                     namedScratchpadAction Scratchpads.pads "terminal")
        , ((Config.modMask, xK_F5),                                     namedScratchpadAction Scratchpads.pads "weechat")
