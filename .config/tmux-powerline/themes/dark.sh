...
TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
  "project $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR $TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}" \
)
...
TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
  ...
  "vcs_rootpath $TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
