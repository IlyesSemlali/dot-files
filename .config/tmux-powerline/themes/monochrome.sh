...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${color_bg}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${color_fg}
TMUX_POWERLINE_SEG_VCS_BRANCH_GIT_SYMBOL_COLOUR=${color_alt_fg}
